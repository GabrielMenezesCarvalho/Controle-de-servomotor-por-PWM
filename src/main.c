...
#include "pwm.h" // Biblioteca para controle de PWM

// Para o experimento com o LED, troque a GPIO pela 11, 12 ou 13
#define SERVO_PIN 22 // Define a GPIO utilizada para conectar-se ao servomotor (22)
...
#define DUTY_CYCLE_90 0.074 // % do duty cycle que corresponde ao braço em 90 graus
